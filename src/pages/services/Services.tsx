    ...
    return (
        <>
            <div className="w-full bg-[#E6F6FE] py-2">
                ...
                <div className="max-w-[1440px] mx-auto min-h-[392px] bg-[#011632] rounded-lg p-16 my-16">
                    <div className="flex items-center justify-center gap-16 w-full">
                        <div className="space-y-4">
                            <h2 className="text-[42px] text-[#fff] font-semibold max-w-[692px] tracking-tight">Leave your worries at the door and enjoy a healthier, more precise smile</h2>
            ...
            <div className="bg-[#E6F6FE] h-[753px] w-full flex flex-col items-center justify-center gap-4 max-w-full mx-auto py-16">
                <div>
            ...
            <div className="max-w-[1280px] mx-auto min-h-[392px] bg-[#011632] rounded-lg p-16 my-16">
                <div className="flex items-center justify-between w-full">
                    <div className="space-y-4">
                        <h2 className="text-[42px] text-[#fff] font-semibold max-w-[752px] tracking-tight">Dental Website that's gonna shake the game rules up.</h2>
                        <p className="text-[#fff] max-w-[531px] text-[18px]">We use only the best quality materials on the market in order to provide the best products to our patients.</p>
                        <button className="bg-[#1376F8] px-6 py-3 rounded-lg text-white">Learn more</button>
                    </div>
                    <div>
