...
const Blogs = () => {
    ...
    return (
        <>
                    ...
                    <div className="flex flex-col items-center justify-center">
                        <div className="space-y-2 flex flex-col gap-4 items-center justify-center">
                            <div className="flex flex-col gap-0">
                                <h1 className="font-semibold text-[58px] tracking-tighter max-w-[687px]">Blogs</h1>
            ...
            <div className="space-y-8 py-16 max-w-[1280px] mx-auto flex flex-col justify-center items-center">
                <div className="flex flex-col gap-0">
                    <h1 className="font-semibold text-[58px] tracking-tighter max-w-[687px]">Articles</h1>
                    <img src="/assets/underline.png" alt="" />
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-4 justify-items-center gap-4">
                    <BlogCard
                        src="/assets/blog1.png"
                        title="Care of your teeth"
                        desc="Lorem ipsum dolor sit amet consectetur."
